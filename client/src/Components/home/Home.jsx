  ...
  return (
    <div>
        ...
        <div className="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
          <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
            ...
            <p className="mt-4 max-w-lg text-white sm:text-xl/relaxed">
              Welcome to Prime Cars, your premier destination for quality
              pre-owned vehicles. Explore our wide range of inspected and
              certified cars, ensuring you drive home in a cool and
              reliable vehicle.
            </p>
      ...
      <div className="my-8 px-8">
        ...
        <div className="gap-4 gap-y-8 grid grid-cols-4 md:grid-cols-3 lg:grid-cols-4 min-h-min">
          {latestCars.length > 0 ? (
